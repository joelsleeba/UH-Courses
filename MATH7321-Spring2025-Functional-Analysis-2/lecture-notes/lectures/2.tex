...
\begin{corollary}
  ...
  be a maximal ideal. Then $A/I = \mathbb{C}$.
\end{corollary}
...
\begin{proof}
  ...
  and $\tau(a) = a + I = \lambda + I_\lambda = \lambda1 + I$ since
  $\lambda1 - a \in I$. Now by the identification of $A/I_\lambda$
...
\begin{remark}
  ...
  $\textrm{Ker}(\tau)$ is a maximal ideal.
\end{remark}
