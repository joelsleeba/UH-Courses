...
\begin{proof}
  ...
  \begin{align*}
    ...
    \eta} \quad f \in C(X)
  \end{align*}
  Now for any $\phi \in \mathcal{M}(X)$, the map
  \begin{align*}
    \mathcal{H}\times \mathcal{H} \to  \mathbb{C} :=  (\xi, \eta)
    \mapsto \int f \ d \mu_{\xi, \eta}
  \end{align*}
  is a bounded sesquilinear form with norm $\|\xi\|\|\eta\|$. Hence
  ...
  \begin{align*}
    ...
    &= \int \phi f \ d \mu_{\Phi(f) \xi, \eta} \\
    &= \langle T_\phi \Phi(f) \xi ,  \eta \rangle
  \end{align*}
  ...
  $C(X)^{**}$, and $\|f_i\| \to \|\phi\|$ (\textcolor{red}{This is
  ...
  Now define $E : \Sigma(A) \to  B(\mathcal{H}) :=   A \mapsto
