...
\begin{proof}
  ...
  \marginnote{ \scriptsize \it \textcolor{red}{verify how $\Phi(a^*) =
    \overline{\Phi(a)}$}. This is evident if elements of $
  \textrm{sp}(\mathcal{A})$ preserve the involution}
...
\begin{proof}
  ...
  $\mathcal{A}$. But this is true because $B(\mathcal{H})$ is a Ck algebra.
\end{proof}
