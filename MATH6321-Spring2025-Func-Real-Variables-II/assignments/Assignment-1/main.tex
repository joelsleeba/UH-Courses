...
\begin{questions}
  ...
  \begin{solution}
    ...
    Moreover by \autoref{eq:2}, for each $\varepsilon > 0$ and $k_j \in
    \mathbb{Z}$, there is
    a $N_{k_j} \in \mathbb{N}$ such that for all $N > N_{k_j}$
    \begin{align*}
      \Bigg| \frac{1}{N} \sum_{n = 1}^{N} f_{k_j}(2\pi n \alpha) -
      \frac{1}{2\pi} \int_{-\pi}^{\pi}  f_{k_j}(t) \ dt\Bigg| <
      \frac{\varepsilon}{2^{k_j}|a_j|}
    \end{align*}
    ...
    \begin{align*}
      ...
      f_{k_j}(2 \pi n \alpha) -  \frac{1}{2\pi}
      \int_{-\pi}^{ \pi}   f_{k_j}(t) \ dt\Bigg| \\
      &< \sum_{j = 1}^{J} \frac{\varepsilon}{2^{k_j}} \\
      &< \varepsilon
    \end{align*}
