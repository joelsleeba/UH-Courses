...
\begin{questions}
  ...
  \begin{solution}
    ...
    We show that $f \in \mathcal{M}$, then $\|f\|_\infty > 1$. If $f
    \in \mathcal{M}$ and $\|f\|_\infty \le 1$, then
    \begin{align*}
      \Big | \int_{0}^{\frac{1}{2}} f(x) \ dx \Big | \le
    ...
    Thus
    \begin{align*}
      \frac{-1}{2} \le \int_{0}^{\frac{1}{2}} f(x) \ dx \le \frac{1}{2}
    \end{align*}
    and
    \begin{align*}
      \frac{-1}{2} \le \int_{\frac{1}{2}}^{1} f(x) \ dx \le \frac{1}{2}
    \end{align*}
    Thus by triangle inequality,
    \begin{align*}
      \Big|\int_{0}^{\frac{1}{2}} f(x) \ dx - \int_{\frac{1}{2}}^{1}
      f(x) \ dx\Big| \le \Bigg| \Big|\int_{0}^{\frac{1}{2}} f(x) \ dx
      \Big| + \Big|\int_{\frac{1}{2}}^{1}f(x) \ dx\Big|\Bigg| \le 1
    \end{align*}
  \end{solution}
  ...
  \begin{solution}
    ...
    under the sup norm, $f_n \to f \in C([0, 1])$. We'll show that $f \in X_m$.
    ...
    \begin{proposition}
      ...
      \end{align*}
      Then for any convergent subsequence $x_{n_k} \to x_0 \in [0, 1]$, we have
