...
\begin{questions}
  ...
  \begin{solution}
    \begin{parts}
      ...
      the module $Z_6 \times Z_6$ over $Z_6$. Then $(2, 3), (3, 2)
      \in \textrm{Tor}(Z_6 \times Z_6)$ \textcolor{red}{verify}

      \part Let $a \in \mathbb{R}$ be a zero divisor such that $ab =
      0$ for some $b \neq 0 \in \mathbb{R}$. For any $x\neq 0 \in M$, the
      $R$-module, consider $bx \in M$. Since $a(bx) = (ab) x = 0x =
      0$, $bx \in \textrm{Tor}(M)$.

      Now to show $bx \neq 0$. \textcolor{red}{verify}
    \end{parts}
  \end{solution}
  ...
  \begin{solution}
    ...
    = 0, \ \forall a \in I \}$. For the same reasoning as we used in
    Problem 1(a), we'll be done if we show that $N_I$ is a subgroup
    of $M$. Let $x, y \in N_I$. Then for any $a \in I$,
    \begin{align*}
      a(x + y) = ax + ay = 0 + 0 = 0
    \end{align*}
    and
    \begin{align*}
      a(-x) = -(ax) = -0 = 0
    \end{align*}
    Thus $x + y, -x \in N_I$ for all $x, y \in N_I$, making it a
    subgroup of $M$. Thus $N_I$ is a submodule of $M$.
  \end{solution}
